...
def main():
    ...
    pygame.display.set_caption('snail trails!!!!!!!!!')
    BASICFONT = pygame.font.Font('freesansbold.ttf', 52)
    pygame.draw.rect(DISPLAYSURF, (0,128,0), (0,0,WINWIDTH,WINHEIGHT))
	...
	if moveRight : wind = wind +1
	    ...
	    if new_y < bottom_line[ new_x ]:
	       ...
	       # Otherwise, we move the flake back to the top
               flake['x'] = random.randint(0,WINWIDTH-9)
